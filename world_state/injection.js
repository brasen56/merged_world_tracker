...
export function applyWorldStateInjection() {
    ...
    try {
        ...
        // applyExtensionPromptInjection prepends the header itself, so body is
        // just the world-state document plus the optional Plot Seeds block.
        let body = worldStateBody;
